...
//    NSLog(@"currentMonth month = %i day = %i, todaydate day = %i",[currentMonth month],[currentMonth day],[todayDate month]);
    ...
    for (int i=0; i<numBlocks; i++) {
        ...
        if (selectedDate && i==selectedDateBlock) {
            CGFloat radius =  30;
            CGRect rect = CGRectMake(targetX,targetY,kVRGCalendarViewDayWidth+2,kVRGCalendarViewDayHeight+2);
            UIBezierPath *path = [UIBezierPath bezierPathWithRoundedRect:rect cornerRadius:radius];
            CGContextSetFillColorWithColor(context, [UIColor colorWithRed:0.925 green:0.251 blue:0.478 alpha:1].CGColor);
         ...
         //   CGContextAddRect(context, rectangleGrid);
            ...
            CGRect rect = CGRectMake(targetX,targetY,kVRGCalendarViewDayWidth+2,kVRGCalendarViewDayHeight+2);
            UIBezierPath *path = [UIBezierPath bezierPathWithRoundedRect:rect cornerRadius:radius];
            CGContextSetFillColorWithColor(context, [UIColor colorWithRed:255.0/255.0 green:92.0/255.0 blue:43.0/255.0 alpha:1].CGColor);
