...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.row ==0) {
        NSLog(@"About page");
        UIStoryboard *storyboard=[UIStoryboard storyboardWithName:@"AboutSettings" bundle:nil];
    ...
    if (indexPath.row ==1) {
         NSLog(@"Terms page");
        UIStoryboard *storyboard=[UIStoryboard storyboardWithName:@"AboutSettings" bundle:nil];
        UIViewController *vc=[storyboard instantiateViewControllerWithIdentifier:@"Terms"];
        [self.navigationController pushViewController:vc animated:YES];
    }
    if (indexPath.row ==2) {
         NSLog(@"FAQ page");
...
//        [self.navigationController pushViewController:vc animated:YES];
    ...
    if (indexPath.row ==4) {
         NSLog(@"Upcoming Features page");
        UIStoryboard *storyboard=[UIStoryboard storyboardWithName:@"AboutSettings" bundle:nil];
        UIViewController *vc=[storyboard instantiateViewControllerWithIdentifier:@"Upcoming"];
        [self.navigationController pushViewController:vc animated:YES];
    }
